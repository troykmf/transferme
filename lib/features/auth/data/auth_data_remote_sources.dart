  ...
  Future<void> completeProfile({
    ...
    try {
      ...
      if (profilePicture != null) {
        profilePictureUrl = await uploadProfilePicture(profilePicture, currentUser.uid);
      }
  ...
  Future<void> login({
    ...
    try {
      ...
      if (!userCredential.user!.emailVerified) {
        ...
        throw AuthException.fromFirebase(Exception('Email not verified'), StackTrace.current);
      }
    } catch (e, stackTrace) {
      throw AuthException.fromFirebase(e, stackTrace);
    }
