...
class AddCardColorScreen extends ConsumerStatefulWidget {
  final CardDetails cardDetails;

  const AddCardColorScreen({super.key, required this.cardDetails});

  @override
  ConsumerState<AddCardColorScreen> createState() => _CardColorScreenState();
}

class _CardColorScreenState extends ConsumerState<AddCardColorScreen> {
  ...
  final Map<Color, String> colorNameMap = {
    const Color(0xFF7DD3E8): 'light blue',
    const Color(0xFF4CAF50): 'green',
    const Color(0xFF2196F3): 'blue',
    const Color(0xFFFF9800): 'orange',
  ...
  void initState() {
    ...
    selectedColor = colorOptions.firstWhere(
      (color) => colorNameMap[color] == widget.cardDetails.color,
      orElse: () => const Color(0xFF7DD3E8),
    );
  }
        ...
        child: ResponsivePadding(
          ...
          child: Column(
            children: [
              ...
              // Description
              Text(
                'Please, select a color to differentiate this card from other cards you have attached and organize your cards better.',
                style: mediumText(
                  isMobile ? 11.5 : 8,
                  AppColor.textLightGreyColor,
                  -.2,
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          widget.cardDetails.holdersName,
                          style: headlineText(
                            isMobile ? 11 : 9,
                            AppColor.whiteColor,
                            null,
              ...
              Expanded(
                child: GridView.builder(
                  ...
                  itemCount: colorOptions.length + 1,
                  itemBuilder: (context, index) {
                    if (index == colorOptions.length) {
                      return Container(
                        decoration: BoxDecoration(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    final updatedCard = CardDetails(
                      ...
                      holdersName: widget.cardDetails.holdersName,
                      expiryDate: widget.cardDetails.expiryDate,
                      cvv: widget.cardDetails.cvv,
                      color: colorNameMap[selectedColor] ?? 'light blue',
                      date: widget.cardDetails.date,
                      cardType: widget.cardDetails.cardType,
                    );
                    ref
                        .read(cardProvider.notifier)
                        .saveCard(updatedCard, context);
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF5C6BC0),
                    shape: RoundedRectangleBorder(
